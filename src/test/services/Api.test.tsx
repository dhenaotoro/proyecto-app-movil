...
import { fetchPqrs, getUserById, registerPqr, registerUser, updateUser } from '../../services/Api';
...
describe('Api', () => {
  ...
  describe('getUserById', () => {
    it('should return User data for the given uuid', async () => {
      const mockResponse = { code: 200, data: { uuid: 'ffff-fffff-fffff-ffff', nombre: 'John', apellido: 'Doe', email: 'john.doe@example.com', telefono: '123456789', front: 'cliente', aceptada_politica_aviso_privacidad: true, direccion: 'Transversal' }, message: 'ok', ok: true};
      fetchMock.mockResponseOnce(JSON.stringify(mockResponse));
